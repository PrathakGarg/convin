...
const addNewHistory = (historyList: HistoryItem[], bucketId: number, cardId: number, cardName: string, link: string): HistoryItem[] => {
...
export const addCardToHistory = (historyList: HistoryItem[], bucketId: number, cardId: number, cardName: string, link: string) => {
    const newHistoryList = addNewHistory(historyList, bucketId, cardId, cardName, link);
